...
export default function Header() {
  ...
  return (
    <header className='z-[99] relative'>
      <motion.div
        className='fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-[#f4f3ee] border-opacity-40 bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] md:w-[48rem] md:rounded-full'
            ...
            <motion.li
              ...
              <Link
                ...
                {link.id === activeSection && (
                  <motion.span
                    className='rounded-full absolute inset-0 -z-10 dark:bg-darkBlue bg-lightBlue'
